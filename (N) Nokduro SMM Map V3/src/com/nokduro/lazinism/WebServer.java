	...
	static class MapHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            String response = "<html><head><title>녹두로 트게더 맵 추천 탐색기 Ver. "+Execute.version+"</title>"
            		...
            		+ "</style>"
            		+ "<script src='http://lazinism.woobi.co.kr/nok/SMM/smmmap.js'></script>"
            		+ "</head><body>"
            		...
            		+ "<tr><th width=800>트게더 제목</th><th width=150>작성자</th><th width=300>맵 코드</th><th width=400>원 제목</th><th width=100>클리어 퍼센트</th><th width=100>북마크 추가</th></tr>";
            int i=1;
            ...
            for(Vector<String> v :this.maindata.mapdata){
            	...
            	response +="</td>";
            	response +="<td>";
            	response +="<button type=\"button\" onclick=\"deleterow("+i+")\" width=100>북마크 추가</button>";
            	response +="</td>";
            	response +="</tr>";
            	i+=1;
            }
